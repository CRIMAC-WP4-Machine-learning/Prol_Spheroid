...
!  real(knd) and integer arrays with dimension maxt
    real(knd) arg(maxt), argvec(maxt), barg(maxt), etainp(maxt), pdnorm(maxt), &
...
!      if(knd == kindd .and. ioprad /= 0) write(70, 115) x, c, m
!115     format(1x,'xcm:', e23.14, e23.14, i5)
!      if(knd == kindq .and. ioprad /= 0) write(20, 120) x, c, m
!      if(knd == kindq .and. ioprad /= 0) write(70, 120) x, c, m
!120     format(1x,'xcm:', e39.30, e39.30, i5)
!end if
if (output) then
!      write(20, 115) x, c, m
!      write(70, 115) x, c, m
...
if (output) then
       ...
       if(ioprad == 2) write(20, 690)l, r1c, ir1e, r1dc, ir1de, r2c, ir2e, r2dc, ir2de, naccr, chr
       if(ioprad == 1) write(20, 710) l, r1c, ir1e, r1dc, ir1de
       !if(ioprad == 2) write(70,709) l, dmlf , idmlfe !, dmlms, idmlmse, dmlmf, idmlmfe
