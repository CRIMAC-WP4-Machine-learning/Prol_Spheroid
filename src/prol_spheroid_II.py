...
class ProlateSpheroid:
    ...
    def __init__(self, settings, solver):
        ...
        freq_resp_file = self.ParentDIR+'/temp/'+'ts_vs_freq_{}_a_{}_b_{}_f1_{}_f2_{}_rhos_{:.2f}_IncAngle_{}_{}_II.csv'.format(settings.prefix, self.a, self.b, int(self.min_freq / 1000),
